...
| next | 7:155 → | sequentially (52 sections left beyond the current 150) |

Progress: **150 of 206** sections rewritten (7:5 – 7:154; 7:25 verified clean, 7:26 – 7:104 all inside the band). Third instalment (7:105 – 7:154, 50 sections): **49,393 words, average ≈988/section**; the same pass closed the seven first-instalment sections that were still under the floor (7:14, 7:16, 7:26, 7:27, 7:28, 7:34 topped up; §7:7 repaired) and the over-cap sections that had been left long (7:13, 7:37, 7:38, 7:43, 7:49, 7:51, 7:53, 7:54, 7:85, 7:89, 7:100), so **every section from 7:5 to 7:154 now sits inside 900–1,100 words**. Review file: `tools/quran-audit/out/rewrites/007/batch_7_105-154.md` (49,661 words). Quote pass on the new range: 360 quoted citations checked against `translation/` with a body-only matcher; every wording mismatch it surfaced (53:2–3; 7:94; 30:33; 29:65 / 17:67; 16:54; 6:44; 6:94–6:130; 18:49; 2:13; 2:280; 16:81; 57:27; 6:160; 57:13; 25:65) was replaced with the repository translation's exact wording, and the same matcher re-run over the older instalments produced eleven fixes. Structural check (`a1_structure.py`) still clean for `007.md`; the only files it flags remain 053.md, 071.md, 094.md. Incident and fix: reinstalling the full-section drafts `07_07.md` / `07_13.md` through `putbody` duplicated the `## Sūrah` heading and blockquote inside §7:7 and §7:13; the duplicate header blocks were excised, both sections reinstalled from body-only drafts, and the file re-verified at exactly 206 sections with no missing verse.
