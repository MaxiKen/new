...
**Project:** Expanded verse-by-verse commentary on Sūrah Ibrāhīm (source: `initial/014.md`, 52 verses).
**Status:** COMPLETE ✅ — All 52 verses generated individually (v001–v052) in strict sequential order, verified contiguous (14:1 → 14:52, no gaps), and merged into ONE final permanent file: `expanded/014.md` (1,847 lines, ~55,000 words, 2026-09-08). Scratch files (`scratch_014/`) deleted after assembly. Grouped verses in the source (14:5–6, 7–8, 11–12, 13–14, 16–17, 19–20, 24–25, 28–29, 32–33, 42–43, 49–50) were separated and given full individual treatment.
**Chapters previously completed:** Sūrah al-Fātiḥah → `expanded/001.md`; Sūrah al-Baqarah (286 verses, 2026-09-07) → `expanded/002.md`.
...
- Locate and read the complete source file already in the workspace (DONE: `initial/014.md`, Sūrah Ibrāhīm, 52 verses, read in full on 2026-09-08).
...
- Structure per verse:
  `## Sūrah Ibrāhīm [Chapter:Verse]`  (e.g., `## Sūrah Ibrāhīm 14:1`)
  > **Verse Translation**
  **Expanded Commentary**
...
## 7. Final File
- No separate permanent deliverable files for individual verses; scratch files (`scratch_014/`) are working files only and are deleted after assembly.
- After every verse is completely generated: assemble all verse commentaries in correct order; preserve each verse as an independent, clearly separated section; create ONE final permanent file `expanded/014.md` for the complete chapter; do not shorten, summarize, merge, or compress any verse during assembly.
