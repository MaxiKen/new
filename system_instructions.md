...
**Project:** Expanded verse-by-verse commentary on Sūrah al-Ṭāriq (Chapter 86; source: `initial/086.md`, 17 verses).
**Status:** COMPLETE ✅ — All 17 verses of Chapter 086 generated individually (v001–v017), verified contiguous, merged into ONE final permanent file: `expanded/086.md` (2026-09-08). Scratch files deleted. Previously COMPLETE ✅: Sūrah al-Fātiḥah → `expanded/001.md`; Sūrah al-Baqarah → `expanded/002.md` (all 286 verses, 2026-09-07).
