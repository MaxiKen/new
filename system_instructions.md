...
**Project:** Expanded verse-by-verse commentary on Sūrah al-Dhāriyāt (source: `initial/051.md`, 60 verses).
**Status:** COMPLETE ✅ — All 60 verses generated individually (v001–v060), verified contiguous, merged into ONE final permanent file: `expanded/051.md` (2026-09-08). Scratch files deleted. Chapters previously completed: Sūrah al-Fātiḥah → `expanded/001.md`; Sūrah al-Baqarah → `expanded/002.md`; Sūrah al-Dhāriyāt → `expanded/051.md`.
...
- Locate and read the complete source file already in the workspace (DONE: `initial/051.md`, Sūrah al-Dhāriyāt, 60 verses).
...
- Structure per verse:
  `## Sūrah al-Dhāriyāt [Chapter:Verse]`
  > **Verse Translation**
  **Expanded Commentary**
