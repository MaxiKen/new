...
**Project:** Expanded verse-by-verse commentary on Sūrah Āl ʿImrān (source: `initial/003.md`).
**Status:** COMPLETE — Chapter 3 (Sūrah Āl ʿImrān, all 200 verses) finished 2026-09-07 → `expanded/003.md` (single permanent file; scratch deleted post-merge). Completed chapters: Sūrah al-Fātiḥah → `expanded/001.md`; Sūrah al-Baqarah → `expanded/002.md` (all 286 verses); Sūrah Āl ʿImrān → `expanded/003.md` (all 200 verses, ~162,000 words).
...
- Locate and read the complete source file already in the workspace (`initial/003.md`, Sūrah Āl ʿImrān, 200 verses).
...
- After completing a verse, retain it locally in the workspace as completed content (scratch file), then immediately continue to the next verse.
- Do not stop, pause, wait for approval, ask questions, or provide progress updates between verses.
- Completing one verse automatically triggers generation of the next; continue first verse through final verse (v200).
...
- Views of classical scholars: al-Ṭabarī, Ibn Kathīr, al-Qurṭubī, al-Rāzī, Ibn ʿAbbās, Ibn Taymiyyah, and others where relevant.
...
1. This `system_instructions.md` was created/saved as the persistent instruction file (updated for Chapter 3).
...
- After every verse is completely generated: assemble all verse commentaries in correct order; preserve each verse as an independent, clearly separated section; create ONE final permanent file `expanded/003.md` for the complete chapter; do not shorten, summarize, merge, or compress any verse during assembly; delete scratch files after merge.
...
- Strategy: READ SOURCE → GENERATE VERSE 1 → RETAIN → GENERATE VERSE 2 → RETAIN → CONTINUE AUTOMATICALLY → VERSE 200 → MERGE ALL → ONE COMPLETE FINAL FILE (`expanded/003.md`).
