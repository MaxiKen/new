...
**Project:** Expanded verse-by-verse commentary on Sūrah al-Anʿām (Chapter 6, 165 verses; source: `initial/006.md`).
**Status:** COMPLETE — Sūrah al-Anʿām (165 verses) fully generated verse-by-verse and merged into ONE final permanent file `expanded/006.md`; scratch directory `work/006/` removed. Chapters completed: Sūrah al-Fātiḥah → `expanded/001.md`; Sūrah al-Baqarah → `expanded/002.md` (286 verses); Sūrah al-Anʿām → `expanded/006.md` (165 verses).
...
- Locate and read the complete source file already in the workspace (current: `initial/006.md`, Sūrah al-Anʿām, 165 verses).
