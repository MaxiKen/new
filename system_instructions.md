...
**Status:** COMPLETE ✅ — Sūrah al-Fātiḥah → `expanded/001.md`; Sūrah al-Baqarah, all 286 verses → `expanded/002.md` (2026-09-07); Sūrah al-Ḥajj, all 78 verses → `expanded/022.md` (2026-09-08). Scratch files deleted.
