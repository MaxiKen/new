...
**Project:** Expanded verse-by-verse commentary on Sūrah al-Dukhān (source: `initial/044.md`, 59 verses).
**Status:** COMPLETE ✅ — All 59 verses generated individually (v01–v59), verified contiguous, merged into ONE final permanent file: `expanded/044.md` (2026-09-09). Scratch files deleted. Chapters previously completed: Sūrah al-Fātiḥah → `expanded/001.md`; Sūrah al-Baqarah → `expanded/002.md`.
