# Qur'an Commentary Expansion System Instructions

**Project:** Expanded verse-by-verse Qur'an commentary (sources: `initial/NNN.md`).
**Status:** Sūrah al-ʿAlaq COMPLETE ✅ — All 19 verses generated individually (v001–v019) plus sūrah introduction, verified contiguous, merged into ONE final permanent file: `expanded/096.md` (2026-09-08). Scratch files deleted.
**Chapters completed:** al-Fātiḥah → `expanded/001.md`; al-Baqarah (286 verses) → `expanded/002.md`; al-Tīn (8 verses) → `expanded/095.md`; al-ʿAlaq (19 verses) → `expanded/096.md`; al-Qadr → `expanded/097.md`.
...
- Locate and read the complete source file already in the workspace (DONE: `initial/001.md`, `initial/002.md`, `initial/095.md`, `initial/096.md`, `initial/097.md`).
