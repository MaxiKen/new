...
**Project:** Expanded verse-by-verse commentary on Sūrah al-Inshiqāq (source: `initial/084.md`).
**Status:** COMPLETE ✅ — All 25 verses of Chapter 84 (al-Inshiqāq) generated individually (v001–v025), verified contiguous, merged into ONE final permanent file: `expanded/084.md` (2026-09-10). Scratch files deleted. Chapters previously completed: Sūrah al-Fātiḥah → `expanded/001.md`; Sūrah al-Baqarah → `expanded/002.md` (286 verses, merged 2026-09-07).
