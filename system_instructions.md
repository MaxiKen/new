...
- After completing a verse, retain it locally in the workspace/session as completed content, then immediately continue to the next verse.
...
2. It must be programmatically read/reloaded before commentary generation.
...
- Individual verse commentaries may be generated and retained locally/session-wise only to make continuous long-form generation reliable.
