...
**Project:** Expanded verse-by-verse commentary on Sūrah al-ʿAṣr (Chapter 103) — source: `initial/103.md`
**Status:** COMPLETE ✅ — All 3 verses generated sequentially (v1–v3), verified contiguous, merged into ONE final permanent file: `expanded/103.md` (2026-09-09). Previously completed chapters: Sūrah al-Fātiḥah → `expanded/001.md`; Sūrah al-Baqarah → `expanded/002.md`; Sūrah al-Qāriʿah → `expanded/101.md`; Sūrah al-Takāthur → `expanded/102.md`.
...
- Locate and read the complete source file already in the workspace: `initial/103.md`, Sūrah al-ʿAṣr, 3 verses.
...
- Purpose: Prevent long chapter from causing truncation, compression, summarization, or loss of detail.
...
- Views of classical scholars: al-Ṭabarī, Ibn Kathīr, al-Qurṭubī, Ibn ʿAbbās, Ibn Taymiyyah, al-Shāfiʿī, al-Rāzī, al-Baghawī, and others where relevant.
...
- Depth must match expanded/002.md standard.
...
- After every verse is completely generated: assemble all verse commentaries in correct order; preserve each verse as an independent, clearly separated section; create ONE final permanent file for the complete chapter: `expanded/103.md`; do not shorten, summarize, merge, or compress any verse during assembly.
...
- Strategy: READ SOURCE → GENERATE VERSE 1 → RETAIN → GENERATE VERSE 2 → RETAIN → GENERATE VERSE 3 → MERGE ALL → ONE COMPLETE FINAL FILE.
- The final result must contain the full, unshortened, deeply expanded commentary for the entire chapter.
