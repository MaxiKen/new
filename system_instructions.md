...
**Project:** Expanded verse-by-verse commentary on Sūrah an-Nās (source: `initial/114.md`).
**Status:** COMPLETE ✅ — All 6 verses generated individually (v001–v006; source's grouped vv. 1–3 split into independent commentaries), verified contiguous, merged into ONE final permanent file: `expanded/114.md` (2026-09-09). Scratch files deleted. Chapters previously completed: Sūrah al-Fātiḥah → `expanded/001.md`; Sūrah al-Baqarah → `expanded/002.md`.
