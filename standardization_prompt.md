...
- verified hadith
- additional Qur'anic cross-references
- historical context
...
> <exact translation from translation/{{NNN}}.txt>
...
- reports from early authorities
- statements of recognised exegetes
- historical evidence
- legal evidence
...
- verse-specific focus
- relevant scholarship
- relevant evidence
- verified hadith
- verified Qur'anic quotations
- appropriate depth
- meaningful mini-headings
- logical reasoning
- relevant examples
- natural prose
...
- median words per verse
- shortest verse commentary
- longest verse commentary
- average mini-headings per verse
- minimum mini-headings
- maximum mini-headings
...
- total increase
- percentage increase
- initial average words/verse
- final average words/verse
- initial average headings/verse where measurable
- final average headings/verse
...
- number of individual verse files created
- final word count
- initial word count
- percentage increase
- average words per verse
- average mini-headings per verse
- comparison with the expected standard
...
Do not restructure existing commentary.

Do not programmatically rewrite existing commentary.

Do not mechanically paraphrase existing commentary.

Do not preserve existing paragraphs as the foundation of the new work.

Do not treat the initial commentary as text to be edited.
